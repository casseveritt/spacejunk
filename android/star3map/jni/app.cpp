...
VarFloat app_latitude( "app_latitude", "viewer current latitude", Var_Archive, 0.0f );
...
void platformMain () {
	...
	r3::Init( 0, NULL );
        ...
        r3::FileDelete( "bg-default.bind" );
	glClearColor(0, 0, 0, 0);
        r3::Output( "GL Vendor: %s", glGetString( GL_VENDOR) );
        r3::Output( "GL Renderer: %s", glGetString( GL_RENDERER ) );
        r3::Output( "GL Version: %s", glGetString( GL_VERSION ) );
        r3::Output( "GL Extensions: %s", glGetString( GL_EXTENSIONS ) );
}
