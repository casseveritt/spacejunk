...
extern "C" {
	JNIEXPORT void JNICALL Java_us_xyzw_star3map_star3mapNative_Init( JNIEnv * env, jobject obj, jobject activity );
    JNIEXPORT void JNICALL Java_us_xyzw_star3map_star3mapNative_ExecuteCommand(JNIEnv * env, jobject obj, jstring cmd);
	JNIEXPORT void JNICALL Java_us_xyzw_star3map_star3mapNative_Quit( JNIEnv * env, jobject obj );
	JNIEXPORT void JNICALL Java_us_xyzw_star3map_star3mapNative_Pause( JNIEnv * env, jobject obj );
	JNIEXPORT void JNICALL Java_us_xyzw_star3map_star3mapNative_Resume( JNIEnv * env, jobject obj );
	JNIEXPORT void JNICALL Java_us_xyzw_star3map_star3mapNative_Touches( JNIEnv * env, jobject obj, jint count, jintArray points );
	JNIEXPORT void JNICALL Java_us_xyzw_star3map_star3mapNative_Accel( JNIEnv * env, jobject obj, jfloat x, jfloat y, jfloat z );
	JNIEXPORT void JNICALL Java_us_xyzw_star3map_star3mapNative_Location( JNIEnv * env, jobject obj, jfloat latitude, jfloat longitude );
	JNIEXPORT void JNICALL Java_us_xyzw_star3map_star3mapNative_Heading( JNIEnv * env, jobject obj, jfloat x, jfloat y, jfloat z, jfloat trueDiff );
    JNIEXPORT void JNICALL Java_us_xyzw_star3map_star3mapNative_Reshape(JNIEnv * env, jobject obj,  jint width, jint height);
    JNIEXPORT void JNICALL Java_us_xyzw_star3map_star3mapNative_Display(JNIEnv * env, jobject obj);

    JNIEXPORT void JNICALL Java_us_xyzw_star3map_star3mapNative_SetStatus( JNIEnv * env, jobject obj, jstring status );
};
...
static void regalerr( GLenum err ) {
  ...
  switch( err ) {
    ...
    default:
                           LOGE( "Got a GL error: %d!\n", err );
                           break;
  }
  if( errstr ) {
    LOGE( "Got a GL error: %s\n", errstr );
  }
  ;
}
...
JNIEXPORT void JNICALL Java_us_xyzw_star3map_star3mapNative_Reshape(JNIEnv * env, jobject obj,  jint width, jint height)
{
  ...
  if ( realInit == false ) {
		...
		//r3::Init( 0, NULL );
                void * eglctx = eglGetCurrentContext();
		LOGI("calling platformMain! - eglctx = %p", eglctx );
                RegalMakeCurrent( eglctx );
